...
@click.option(
    "--force",
    default=False,
    help="When `True`, rewrite the files if they already exist",
)
@click.command()
def main(
    tmp_folder,
    ...
    pdb_ids = (
        ...
        .__eq__("Protein (only)")
        .and_("rcsb_entry_info.resolution_combined")
        .__le__(RESOLUTION_THR)
    )
    if filter_methods:
    ...
    if remove_redundancies:
        removed = remove_database_redundancies(
