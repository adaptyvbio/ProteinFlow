...
def dowload_dataset_from_s3(train_clusters_dict, valid_clusters_dict, test_clusters_dict, dataset_path='bestprot_dataset', s3_path='s3://ml4-main-storage/bestprot_20221110/'):
